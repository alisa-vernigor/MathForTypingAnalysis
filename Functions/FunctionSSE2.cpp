...
namespace NSFunctions {
    double CDensity0::compute0_SSE2(const std::vector<double>& means, double arg) {
      double tmp_result = 0;
    ...
    double CDensity1::compute1_SSE2(const std::vector<double>& means, double arg) {
      double tmp_result = 0;
      size_t regular_part = means.size() & static_cast<size_t>(-2);
    ...
    double CDensity2::compute2_SSE2(const std::vector<double>& means, double arg) {
      double tmp_result = 0;
      size_t regular_part = means.size() & static_cast<size_t>(-2);
